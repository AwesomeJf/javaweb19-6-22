...
//    public Orders(Integer trip, Integer num, Date startTime, Float totalPrice, Integer user) {
//        this.trip = trip;
//        this.num = num;
//        this.startTime = startTime;
//        this.totalPrice = totalPrice;
...
//    }
//
//    public Orders(Integer id, String orderno, Integer trip, Integer num, Date startTime, String goPoint, String goTime, Float totalPrice, Integer state, Date createTime, Integer user, Trip trips, Sequence sequence, User users) {
//        this.id = id;
