                    ...
                    .each(
                        ...
                        function (i, com) {
                            ...
                            if (com.imgs.length > 0) {
                                ...
                                for (var i = 0; i < com.imgs.length; i++) {
                                    html += '<li><a href="'
                                        + getRootPath()
                                        + '/image_cache/'
                                        + com.imgs[i]
